...
<head runat="server">
    <title> Rubber Ducky's Computer Shop</title>
</head>
...
<body>   
    <form id="form1" runat="server">
        ...
        <header>
                <div id="NotLoggedIn" style="float:right" runat="server">
                ...
                <div id="LoggedIn" style="float:right" runat="server" visible="false">
                    <asp:Label ID="CurrentUserLoggedIn" runat="server"></asp:Label>
                    <asp:Button ID="Logout" OnClick="Logout_Click" runat="server" Text="Logout" />
                    <asp:Button ID="ViewContents" OnClick="ViewContents_Click" runat="server" Text="View Submitted Orders" />
                </div>
        ...
        <div id="ShoppingCartContents" class="modalAddComputer" runat="server" visible="false">
            <asp:Panel ID="ModalShoppingCart" runat="server" CssClass="modalForm">         
                <asp:Label ID="SubmitError" Text="" runat="server" BorderColor="Red"></asp:Label><br/>
        ...
        <div class="HeaderRight">
            <div class="ShoppingCart">
                ...
                <asp:Label ID="ShoppingCart" Width="130" onClick="ViewShoppingCartContents" runat="server" Text="Items: 0 - $0.0"></asp:Label>
            ...
            <div class="SearchBar" id="search" runat="server">         
                 <asp:TextBox Width="200" Height="30" ID="txtSearchMaster" runat="server"></asp:TextBox>
